function [SeparationUT, PhaseError, AmplitudeError] = TidesCode_NonMigrating_Function_Scen3(Satellites)
...
Noise = 0.1;           % SNR = 20 and 10 dB or 10%, 1%, 0.1%, signal to "Kolmogorov Waves" ratio 
