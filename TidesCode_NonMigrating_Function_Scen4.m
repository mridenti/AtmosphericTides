function [SeparationUT, PhaseError, AmplitudeError] = TidesCode_NonMigrating_Function_Scen4(Satellites)
...
Amplitude = [0.02 0.009 0.002; 0.02 0.009 0.002; 0.02 0.009 0.002; ... 
    0.02 0.009 0.002; 0.02 0.009 0.002; 0.02 0.009 0.002; 0.02 0.009 0.002]; 
...
SeparationUT = 0:0.001:(12/Orbits)/Satellites; % Interval between equatorial crossings in UT
...
if (make_ani_res ~= 0) 
    filename_res = 'residuals_test.gif';
